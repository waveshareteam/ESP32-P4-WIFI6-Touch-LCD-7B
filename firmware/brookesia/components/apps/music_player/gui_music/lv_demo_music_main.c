...
lv_obj_t * _lv_demo_music_main_create(lv_obj_t * parent, file_iterator_instance_t *iterator)
{
    ...
    static lv_coord_t grid_rows[] = {APP_DEMO_MUSIC_HANDLE_SIZE,     /*Spacing*/
    ...
    static const lv_coord_t grid_cols[] = {LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    static const lv_coord_t grid_rows[] = {APP_DEMO_MUSIC_HANDLE_SIZE,     /*Spacing*/
                                           LV_GRID_FR(1),   /*Spacer*/
                                           LV_GRID_CONTENT, /*Title box*/
                                           LV_GRID_FR(3),   /*Spacer*/
                                           LV_GRID_CONTENT, /*Icon box*/
...
void _lv_demo_music_resume(void)
{
    ...
    if (!pause_exit && pause && product_audio_player_is_playing_by_index(file_iterator, track_id)) {
        LV_LOG_USER("Resume music");
        audio_player_resume();
    } else {
        pause_exit = false;
        LV_LOG_USER("Music is not playing. Start playing.");
        product_audio_player_play_index(file_iterator, track_id);
    }
